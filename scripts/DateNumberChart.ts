...
export class DateNumberChart implements Control {
    ...
    private chartDomPoints: Array<DOMPoint> = [];
    ...
    private redraw() {
        ...
        for (const pair of this.values) {
            ...
            this.chartDomPoints.push(point);
    ...
    private mouseMove(e: MouseEvent) {
        ...
        // TODO: Optimize
        const point = this.findPoint(offsetViewBoxX);
        const offsetPxY = (point.y / this.viewBoxHeight) * this.svg.clientHeight;
        ...
        this.infoDotDiv.style.setProperty('left', `${(point.x / this.viewBoxWidth) * this.svg.clientWidth - (this.infoDotDiv.clientWidth / 2)}px`);
    }
    ...
    private getDatesOfNthDay(nthDay: Date, minDaysRange: number): Array<Date> {
